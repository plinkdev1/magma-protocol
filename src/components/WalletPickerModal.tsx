...
const WALLETS = [
  {
    ...
    name: 'Phantom',
    deepLink: 'phantom://',
    logo: require('../../assets/logos/wallets/phantom.jpg'),
  },
  {
    id: 'backpack',
    name: 'Backpack',
    deepLink: 'backpack://',
    logo: require('../../assets/logos/wallets/backpack.jpg'),
  },
  {
    id: 'solflare',
    name: 'Solflare',
    deepLink: 'solflare://',
    logo: require('../../assets/logos/wallets/solflare.jpg'),
  },
  {
    id: 'jupiter',
    name: 'Jupiter',
    deepLink: 'jupiter://',
    logo: require('../../assets/logos/wallets/jupiter.png'),
  },
];
          ...
          <View style={styles.grid}>
            {WALLETS.map((wallet) => (
              <TouchableOpacity
                ...
                onPress={() => handleWalletSelect(wallet.deepLink)}
